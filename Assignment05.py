...
# Summer 2024
# Abdul Mutallif
# Assignment 5 -  Data Scraping, Storage, and Visualization
# Worked with class
...
def get_country_population():
    ...
    while True:
        try:
            ...
            # print(f"Junk 1: {junk1}, junk 2: {country}, junk 3: {population}, junk 4: {junk4}, junk 5: {junk5}")
            # print(f"junk 6: {junk6}, junk 7: {junk7}, junk 8: {junk8}, junk 9: {junk9}, junk 10: {junk10}, junk 11: {junk11}, junk 12: {junk12}")
...
def main():
    ...
    ou.write_xml_file("Assignment05.xml", title, headers, data, do_open=True)
